...
import { SlateReactPresentation } from '@react-page-styled/slate-react-presentation'; // use a fork until https://github.com/rockettomatooo/slate-react-presentation/pull/7 is merged
